...
const HtmlRave = (props) => {
    const { FLW_PUBLIC_KEY, tx_ref, amount, currency, country, payment_options, redirect_url, consumer_id, subaccount, consumer_mac, email, phone_number, name, title, description, logo, } = props;
    return `
   <!DOCTYPE html>
   <html lang="en">
           <head>
