...
const react_native_autoheight_webview_1 = __importDefault(
	require("react-native-autoheight-webview")
);
				...
				case "successful":
					{
						try {
							...
							const resp = yield (0, utils_1.verifyPayment)({
								FLW_SECRET_KEY,
								ref,
							});
							// console.log(
							//         "Status: ", resp.data.status === "successful", "Currency: ", resp.data.currency === props.currency, "Amount: ", resp.data.amount == props.amount
							// )
							// console.log("Amount => ")
							if (
								...
								return props.onSuccess({
									data: resp,
									deposit: resp.data.amount_settled,
								});
							} else {
								setvalue(
									Object.assign(Object.assign({}, value), {
								...
								console.log(resp);
								return props.onVerifyingError({
									error:
										"Error in verifying user payment, However, user may bill",
								});
							}
						} catch (error) {
							setvalue(
	...
	return (
		<react_native_1.View style={styles.container}>
			<react_native_1.Modal
				...
				transparent={true}
			>
				<react_native_autoheight_webview_1.default
					source={{ html: (0, HtmlRave_1.HtmlRave)(payLoad) }}
					...
					onLoadStart={() => {
						setvalue(
							Object.assign(Object.assign({}, value), { loading: true })
						);
					}}
					onLoadEnd={() =>
						setvalue(
							Object.assign(Object.assign({}, value), { loading: false })
						)
					}
					javaScriptEnabled
					...
					<>
						{customButton ? (
							<react_native_1.TouchableOpacity
								...
								onPress={() => {
									setvalue(
										Object.assign(Object.assign({}, value), { visible: true })
									);
								}}
								style={{
									height: "100%",
